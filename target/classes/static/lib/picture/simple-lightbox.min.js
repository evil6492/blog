    ...
    e.fn.simpleLightbox = function (i) {
        var i = e.extend({
            ...
            h = !1, m = 0, v = e(), x = e("<div>").addClass("sl-caption"), b = function (t) {
                ...
                t.trigger(e.Event("show.simplelightbox")), h = !0, m = e(r).index(t), o = e("<img/>").hide().attr("src", t.attr("href")), e(".sl-image").html(""), o.appendTo(e(".sl-image")), d.fadeIn("fast"), e(".sl-close").fadeIn("fast"), f.show(), u.fadeIn("fast"), T(), i.preloading && k(), setTimeout(function () {
                ...
                if (!(h || (0 > n || n >= e(r).length) && 0 == i.loop)) {
                    ...
                    p ? E(i.animationSpeed / 1e3, -100 * t - a + "px") : s.left = parseInt(e(".sl-image").css("left")) + -100 * t + "px", e(".sl-image").animate(s, i.animationSpeed, function () {
                        setTimeout(function () {
                            var n = e(r).eq(m);
                            o.attr("src", n.attr("href")), e(".sl-caption").remove(), T(t), i.preloading && k()
                        }, 100)
                    })
                }
            }, I = function () {
        ...
        w(), e(t).on("resize", T), e(n).on("click." + c, this.selector, function (t) {
            if (b(this)) {
        ...
        return e(n).on("touchstart mousedown pointerdown MSPointerDown", ".sl-image", function (e) {
            ...
            q = !1, Math.abs(a) > i.swipeTolerance ? S(a > 0 ? 1 : -1) : p ? E(i.animationSpeed / 1e3, "0px") : v.animate({left: X + "px"}, i.animationSpeed / 2)
            ...
            e(n).unbind("click." + c).unbind("keyup." + c), I(), e(".sl-overlay, .sl-wrapper").remove()
        }, this
    }
